...
namespace SoulsFormats.Util {
    internal static partial class Oodle26 {
        ...
        public static byte[] Decompress(byte[] source, long uncompressedSize) {
            ...
            byte[] rawBuf = GC.AllocateUninitializedArray<byte>((int)decodeBufferSize);
        ...
        private static partial long OodleLZ_Compress(
        ...
        [LibraryImport("oo2core_6_win64.dll")]
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvStdcall) })]
        private static partial long OodleLZ_Decompress(
            [MarshalAs(UnmanagedType.LPArray)]
            byte[] compBuf,
            long compBufSize,
            [MarshalAs(UnmanagedType.LPArray)]
        ...
        private static long OodleLZ_Decompress(byte[] compBuf, long compBufSize, byte[] rawBuf, long rawLen)
            => OodleLZ_Decompress(compBuf, compBufSize, rawBuf, rawLen,
                ...
                0, 0, 0, 0, 0, 0, OodleLZ_Decode_ThreadPhase.OodleLZ_Decode_Unthreaded);
