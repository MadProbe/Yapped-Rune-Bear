    ...
    public partial class MSBD {
        ...
        public class PartsParam : Param<Part>, IMsbParam<IMsbPart> {
            ...
            public PartsParam() : base() {
                ...
                this.Protobosses = new List<Part.Protoboss>();
            ...
            public Part Add(Part part) {
                switch (part) {
                    ...
                    case Part.Protoboss p: this.Protobosses.Add(p); break;
            ...
            public override List<Part> GetEntries() => SFUtil.ConcatAll<Part>(
                    ...
                    this.Protobosses, this.Navmeshes, this.DummyObjects, this.DummyEnemies, this.ConnectCollisions);
            ...
            internal override Part ReadEntry(BinaryReaderEx br) {
                ...
                return type switch {
                    ...
                    PartType.Protoboss => this.Protobosses.EchoAdd(new Part.Protoboss(br)),
        ...
        public abstract class Part : Entry, IMsbPart {
            ...
            internal virtual void GetNames(MSBD msb, Entries entries) => this.ModelName = MSB.FindName(entries.Models, this.ModelIndex);

            internal virtual void GetIndices(MSBD msb, Entries entries) => this.ModelIndex = MSB.FindIndex(entries.Models, this.ModelName);
            ...
            public class Collision : Part {
                ...
                private protected override void DeepCopyTo(Part part) {
                    ...
                    collision.RefTexIDs = (short[])this.RefTexIDs.Clone();
                }
                ...
                private protected override void ReadTypeData(BinaryReaderEx br) {
                    ...
                    this.RefTexIDs = br.ReadInt16s(16);
                    this.UnkT38 = br.ReadInt16();
                ...
                private protected override void WriteTypeData(BinaryWriterEx bw) {
                    ...
                    bw.WriteInt16s(this.RefTexIDs);
                    bw.WriteInt16(this.UnkT38);
