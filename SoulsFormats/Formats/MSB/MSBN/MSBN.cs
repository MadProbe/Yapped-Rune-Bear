    ...
    public partial class MSBN : SoulsFile<MSBN> {
        ...
        protected internal override void Read(BinaryReaderEx br) {
            ...
            do {
                ...
                switch (type) {
                    case "MODEL_PARAM_ST":
                        this.Models = new ModelSection(br, unk1);
                    ...
                    case "PARTS_PARAM_ST":
                        this.Parts = new PartsSection(br, unk1);
        ...
        public abstract class Section<T> {
            ...
            internal Section(BinaryReaderEx br, int unk1) => this.Unk1 = unk1;
            ...
            /// </summary>
            public override string ToString() => $"{this.Type}:{this.Unk1}[{this.GetEntries().Count}]";
        }
