...
namespace SoulsFormats.Formats.FLVER {
    /// <summary>
    ...
    public interface IFlver {
        ...
        /// </summary>
        IReadOnlyList<SoulsFormats.FLVER.Bone> Bones { get; }

        /// <summary>
        /// Dummy points used to determine hitboxes, particle effects, etc.
        /// </summary>
        IReadOnlyList<SoulsFormats.FLVER.Dummy> Dummies { get; }
    ...
    public interface IFlverMesh {
        ...
        /// </summary>
        IReadOnlyList<SoulsFormats.FLVER.Vertex> Vertices { get; }
    }
}
