...
namespace SoulsFormats.Binder {
    ...
    public abstract class BinderReader : IDisposable {
        ...
        /// </summary>
        public List<BinderFileHeader> Files;
        ...
        /// </summary>
        public byte[] ReadFile(int index) => this.ReadFile(this.Files[index]);

        /// <summary>
        /// Reads file data according to the given header.
        /// </summary>
        public byte[] ReadFile(BinderFileHeader fileHeader) => fileHeader.ReadFileData(this.DataBR).Bytes;
